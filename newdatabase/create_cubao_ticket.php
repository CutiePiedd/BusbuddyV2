...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO cubaotickets (bus_no, service_class, departure_location, destination_location, departure_time, base_fare, trip_hours, available_seats, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
