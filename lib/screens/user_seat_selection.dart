...
class UserSeatSelection extends StatefulWidget {
  ...
  // The number of seats the user can select
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              color: selectedSeats[i * 4]
                                  ? const Color.fromARGB(255, 55, 255, 5)
                                  : Colors.white,
              ...
              children: [
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    backgroundColor:
                        const Color.fromARGB(255, 246, 204, 35), // Text color
                  ),
                  child: const Text(
                    'Back',
                    style: TextStyle(
                ...
                ElevatedButton(
                  onPressed: selectedCount > 0
                      ? () {
                          ...
                          Navigator.pop(context, {
                            ...
                            'selectedCount':
                                selectedCount, // Include the count of selected seats
                          });
                          // Pass selected seats
                        }
                  ...
                  style: ElevatedButton.styleFrom(
                    ...
                    foregroundColor: Colors.white,
                    backgroundColor:
                        const Color.fromARGB(255, 245, 126, 15), // Text color
                  ),
                  child: const Text(
                    'Confirm',
                    style: TextStyle(
